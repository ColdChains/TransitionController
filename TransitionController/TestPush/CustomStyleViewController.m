...
- (QLTransitionStyle)transitionStyle {
    return QLTransitionStylePop | QLTransitionStylePush | QLTransitionStyleCustom;
}
...
// 将要结束转场
- (void)transitionViewController:(UIViewController *)vc willEndTransition:(QLTransitionStyle)transitionStyle transitonStatus:(BOOL)canceled {
    if (transitionStyle & QLTransitionStyleCustom) {
        if (canceled) {
